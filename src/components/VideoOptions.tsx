...
import { CaptionFile, CaptionProps, CaptionStyleState } from '@/types/VideoPlayer';
                                ...
                                {tabNum == 3 &&
                                    <div>
                                        ...
                                        {props.captionProps.captionFiles && props.captionProps.captionFiles.map((ccFile, i) => (
                                            <div key={i} className={`${i == curCcFileIdx ? "text-blue-500" : "text-white"} cursor-pointer h-[1.5em] w-full justify-between rounded-sm flex flex-row items-center
